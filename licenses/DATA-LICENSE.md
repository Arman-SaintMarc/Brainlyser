# FastHisto research data — CC BY 4.0

The FastHisto project team makes the following image data available under the
Creative Commons Attribution 4.0 International licence (CC BY 4.0):

| Data | Location | Distributed in |
|---|---|---|
...
- Allen Institute atlas material in `Code/Brainlyser code/assets/atlas/`, and
  any output that incorporates it (region masks, outlines, registered images),
  which remain under the Allen Institute Terms of Use.
- Third-party models and code (DINOv2, Ultralytics), which keep their own
  licences (see [THIRD_PARTY_NOTICES.md](../THIRD_PARTY_NOTICES.md)).
- The Brainlyser software itself, which is licensed under AGPL-3.0
  ([LICENSE](../LICENSE)).
